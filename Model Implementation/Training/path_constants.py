...
DATA_PATH = dir_path + "/Marmot_data"
...
IMAGE_PATH = f"{dir_path}/image"  # os.path.join(PROCESSED_DATA, "image")
TABLE_MASK_PATH = f"{dir_path}/table_mask"  # os.path.join(PROCESSED_DATA, "table_mask")
COL_MASK_PATH = f"{dir_path}/col_mask"  # os.path.join(PROCESSED_DATA, "col_mask")
